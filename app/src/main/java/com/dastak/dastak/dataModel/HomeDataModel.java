...
public class HomeDataModel {
    ...
    public static final String[] description = new String[]{"The Good Life \n Foundation","Drugs \n Information","Drugs We \n Treat",
            "Director \n Message","Our Advisory \n Board","Become Our \n Member","SOS","Seeking Help "};

    public static final int[] imageSource = new int[]{R.mipmap.logo_green,R.mipmap.no_drugs,R.mipmap.drugs_we_treat,
